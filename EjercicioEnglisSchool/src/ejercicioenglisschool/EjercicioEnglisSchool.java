package ejercicioenglisschool;

import java.util.Scanner;

public class EjercicioEnglisSchool {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Ingrese la edad del alummno");
        ...
        if (edad >= 4 && edad <= 6) {
            ...
            if (edad >= 7 && edad <= 8) {
                ...
                if (edad >= 9 && edad <= 10) {
                    ...
                    if (edad >= 11 && edad <= 13) {
                        System.out.println("El horario del grupo 3st year, es Lunes y Miercoles de 17 a 18:30hs");
                    } else {
                        System.out.println("TU HIJO NO ESTA EN CLASE...");
                    }
                }
            }
        }
